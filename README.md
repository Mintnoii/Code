...
> **“工欲善其事，必先利其器。”** 在学习前端的知识之前，一些有意义的准备工作，可以提升以后学习和工作的效率。

**科学上网**

在这里我就不吐槽百度的搜索有多坑了，一句话，如果你想成为一名程序员或者是工程师，学会科学上网应该是你的必备技能。
...
对于程序员来说，代码编辑器绝对是最重要的开发工具之一。我常用的编辑器是`Sublime Text3`用来书写简单的项目，大一点的项目则使用`VS Code`。
...
- [慕课网](https://www.imooc.com/)
  ...
  > 其实慕课网上的一些收费视频网上也都有资源，如果可以给我Star的话 我很乐意告诉你一些东西 哈哈
...
- [JavaScript从入门到精通-Blue](https://www.bilibili.com/video/av29885002)

### 推荐书籍：

**1. 《Head first HTML&CSS》**（浅显易懂，但感觉不如下面的这本）
**2. 《JavaScript DOM编程艺术》**（我的第一本前端入门书籍）
**3. 《Javscript 高级程序设计》**（JS圣经 红宝书 必读书籍，没有之一） 
...
- [Web前端性能优化](https://www.bilibili.com/video/av27157722/)
